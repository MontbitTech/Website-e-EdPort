                         ...
                         <div class="col-lg-12">
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll" aria-expanded="true" aria-controls="generalonecoll">
                                     ...
                                     <p class="media-body"> How to Login to e-EdPort Virtual Learning Platform? </p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll1" aria-expanded="true" aria-controls="generalonecoll1">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body">Where do I find the platform URL for e-EdPort Virtual Learning Platform? </p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll2" aria-expanded="true" aria-controls="generalonecoll2">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> How to conduct classes online through e-EdPort Virtual Learning Platform? </p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll3" aria-expanded="true" aria-controls="generalonecoll3">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body">How to give online assignments to students through e-EdPort Virtual Learning Platform?</p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll4" aria-expanded="true" aria-controls="generalonecoll4">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body">Can we attach a word or PDF file from our computer for online assignments?</p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll5" aria-expanded="true" aria-controls="generalonecoll5">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> Can we use Google Drive files for online assignments?</p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll6" aria-expanded="true" aria-controls="generalonecoll6">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> What if a teacher needs some assistance, while using the e-EdPort Virtual Learning Platform?</p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll7" aria-expanded="true" aria-controls="generalonecoll7">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> How to reset login password for e-EdPort Virtual Learning Platform? </p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll8" aria-expanded="true" aria-controls="generalonecoll8">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> How could a teacher send online notifications to their students?</p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll9" aria-expanded="true" aria-controls="generalonecoll9">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> Can students be notified before a class? </p>
                                 </div>
                             ...
                             <div class="card bg-light border-top-0 shadow-none mb-2 border" style="max-width: 100% !important; ">
                                 <div class="border mb-0 text-left collapsed pt-2 pb-2 pl-2 media" id="generalone" style="cursor: pointer;" data-toggle="collapse" data-target="#generalonecoll10" aria-expanded="true" aria-controls="generalonecoll10">
                                     <i class="fa fa-plus align-self-start mr-1 mt-1"></i>&nbsp;
                                     <p class="media-body"> How could I record a live class through e-EdPort Virtual Learning Platform? </p>
                                 </div>
