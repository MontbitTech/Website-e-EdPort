             ...
             <div class="col-md-12 p-0  col-lg-6  mt-4 col-12 ">
                 <div class="row">
                     <div class="col-md-12 d-flex justify-content-center col-lg-6 col-12  ">
                         <a href="{{route('services.form')}}" class="btn bg-white rounded-pill btn-hover mr-3 wow fadeInRight" data-wow-duration=".8s" data-wow-delay="0s" style="color: #161f33;">Request A Demo &#x27A7;
                         </a>
                     </div>
