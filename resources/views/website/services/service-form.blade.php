        ...
        <form role="form" id="saveteacher" enctype="multipart/form-data" method="post" action="{{route('savecontact')}}">
            <div class="card-body m-0 p-0">
                <div class="row m-0 p-0 pb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="entityvalue">Service</label>
                            <select class="form-control" name="entityvalue" id="entityvalue">
                                <option value="" selected>Select Service</option>
                                <option value="Teacher">e-edport smart teacher training</option>
                                <option value="School">e-edport smart teacher certification</option>
                                <option value="Coaching">e-edport student career counselling</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
