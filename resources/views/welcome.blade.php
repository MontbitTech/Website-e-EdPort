  ...
  @section('heading') Providing Solutions for Systematic Growth of Teaching & Learning @endsection
  @section('sub-heading') Understanding New Trends in Educational Technology @endsection
